...
public class Cart extends DriverSetup{
	...
	public void removeAnItem() { 
		driver.findElement(By.xpath("//tbody/tr[1]/td[4]/div[1]/span[1]/button[2]/i[1]")).click();
	...
	public void checkout() {
		WebElement checkout_btn = driver.findElement(By.xpath("(//a[@class='btn btn-primary'])[1]"));
